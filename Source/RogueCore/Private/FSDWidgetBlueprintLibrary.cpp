...
void UFSDWidgetBlueprintLibrary::SetOverlaySlot(UWidget* InWidget, TEnumAsByte<EHorizontalAlignment> InHorizontal, TEnumAsByte<EVerticalAlignment> InVertical, FMargin InPadding) {
}

void UFSDWidgetBlueprintLibrary::SetMousePosition(UObject* WorldContextObject, int32 X, int32 Y) {
}

bool UFSDWidgetBlueprintLibrary::SetHorizontalSlot(UWidget* Widget, FSlateChildSize Size, TEnumAsByte<EHorizontalAlignment> HorizontalAlignment, TEnumAsByte<EVerticalAlignment> VerticalAlignment, FMargin Padding) {
    return false;
}
...
void UFSDWidgetBlueprintLibrary::ResetAnimationToStartTime(UUserWidget* Widget, UWidgetAnimation* Animation) {
}
...
TArray<UWidget*> UFSDWidgetBlueprintLibrary::GetAllChildrenOfClass(UPanelWidget* Panel, TSubclassOf<UWidget> WidgetClass) {
    return TArray<UWidget*>();
}
...
UScaleBox* UFSDWidgetBlueprintLibrary::CreateScaleBox(UObject* WorldContext, TEnumAsByte<EStretch::Type> InStretch, TEnumAsByte<EStretchDirection::Type> InStretchDirection) {
    return NULL;
}
