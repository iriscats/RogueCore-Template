...
void USeasonsSubsystem::OnStatChanged(UObject* WorldContext, UMissionStat* Stat, float Value, float change) {
}

void USeasonsSubsystem::OnScripChallengeCompleted(UObject* WorldContext, UMissionStat* Stat, float Value, float change) {
}
