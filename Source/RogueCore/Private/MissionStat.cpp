...
float UMissionStat::GetStatCountTotal(const UObject* WorldContext) const {
    return 0.0f;
}
...
float UMissionStat::GetStatCount(const UObject* WorldContext, const UPlayerCharacterID* characterID) const {
    return 0.0f;
}
