...
void UPlayerRejoinState::Server_RemoveIntValue_Internal_Implementation(const FGuid& ItemKey, const FName& ValueKey) {
}

void UPlayerRejoinState::Server_RemoveFloatValue_Internal_Implementation(const FGuid& ItemKey, const FName& ValueKey) {
}
