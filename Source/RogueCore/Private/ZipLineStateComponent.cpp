...
void UZipLineStateComponent::OnPlayerHit(UPlayerHealthComponent* playerHealth, float RawDamage, float actualDamage, const FDamageData& DamageData, bool anyHealthLost) {
}
