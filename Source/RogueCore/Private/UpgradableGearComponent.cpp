...
bool UUpgradableGearComponent::PurchaseUpgrade(UItemID* ItemID, UItemUpgrade* upgrade, AFSDPlayerController* PlayerController, TSubclassOf<APlayerCharacter> previewedCharacter) const {
    return false;
}
