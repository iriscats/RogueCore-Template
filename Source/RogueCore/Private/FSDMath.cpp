...
float UFSDMath::SignedAngleBetweenVectors(const FVector& v1, const FVector& v2, const FVector& vAxis) {
    return 0.0f;
}
...
float UFSDMath::AngleBetweenDirections(const FVector& v1, const FVector& v2) {
    return 0.0f;
}
