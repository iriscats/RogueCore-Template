...
UDeepPathfinderMovement::UDeepPathfinderMovement(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    this->HorizontalAngleSpeedRaw = 0.00f;
...
void UDeepPathfinderMovement::PushMovementPause() {
}

void UDeepPathfinderMovement::PopMovementPause() {
}
...
float UDeepPathfinderMovement::GetVerticalAngleSpeedRaw() {
    return 0.0f;
}
...
float UDeepPathfinderMovement::GetMaxPawnSpeed() const {
    return 0.0f;
}
...
float UDeepPathfinderMovement::GetHorizontalAngleSpeedRaw() {
    return 0.0f;
}
...
void UDeepPathfinderMovement::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const {
    ...
    DOREPLIFETIME(UDeepPathfinderMovement, AlignTowardsDirection);
