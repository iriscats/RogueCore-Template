...
void UMilestoneAsset::OnMissionStatChanged(UObject* WorldContext, UMissionStat* Stat, float Value, float change) {
}
...
FText UMilestoneAsset::GetTitle(const UObject* WorldContext) const {
    return FText::GetEmpty();
}
...
void UMilestoneAsset::GetCurrentProgress(const UObject* WorldContext, int32& Tier, float& Progress, float& CurrentCount, float& TargetCount) const {
}

int32 UMilestoneAsset::GetClaimedTier(const UObject* WorldContext) const {
    return 0;
}
